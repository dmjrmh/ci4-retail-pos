...
<div class="card">
  <div class="card-header d-flex align-items-center">
    ...
    <a href="<?= base_url('promoitems/create') ?>" class="btn btn-primary btn-sm ml-2">+ Add Promo Item</a>
  </div>
          ...
          <?php foreach ($promoitems as $index => $promoitem): ?>
            <tr>
              ...
              <td class="text-center">
                <a href="<?= base_url('promoitems/edit/' . $promoitem['id']) ?>" class="btn btn-warning btn-sm">
